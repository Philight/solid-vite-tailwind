...
const variablesCSS = fs.readFileSync(__dirname + "/src/css/variables.css", {
  encoding: "utf8",
  flag: "r",
});
...
function readCSS() {
  for (const property of Object.keys(PROPERTY_MODIFIERS)) {
    ...
    PROPERTY_SETTINGS[property] = CSSLines.filter((line) =>
  ...
  theme: {
    extend: {
      colors: {
        ...
        // ...readCSS('color'),
        ...(PROPERTY_SETTINGS.hasOwnProperty("color") &&
          PROPERTY_SETTINGS.color),
      },
      screens: {
        sm: "32em",
        md: "48em",
      ...
      height: {
        screen: "var(--screen-height, 100vh)",
        "screen-no-nav":
          "calc(var(--screen-height, 100vh) - var(--navigation-height))",
        "screen-1/2": "50vh",
      ...
      fontFamily: {
        ...
        // ...readCSS('fontFamily'),
        ...(PROPERTY_SETTINGS.hasOwnProperty("fontFamily") &&
          PROPERTY_SETTINGS.fontFamily),
      },
      fontSize: {
      ...
      boxShadow: {
        ...
        // ...readCSS('boxShadow'),
        ...(PROPERTY_SETTINGS.hasOwnProperty("boxShadow") &&
          PROPERTY_SETTINGS.boxShadow),
      },
      textShadow: {
